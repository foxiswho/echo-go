...
func NewOrderGoodsService() *OrderGoodsService {
	return new(OrderGoodsService)
}

//初始化列表
func orderGoodsNewMakeDataArr() []models.OrderGoods {
	return make([]models.OrderGoods, 0)
}
