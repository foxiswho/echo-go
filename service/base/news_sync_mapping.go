...
func NewNewsSyncMappingService() *NewsSyncMappingService {
	return new(NewsSyncMappingService)
}

//初始化列表
func newsSyncMappingNewMakeDataArr() []models.NewsSyncMapping {
...
func (s *NewsSyncMappingService) GetAll(where []*db.QueryCondition, fields []string, orderBy string, page int, limit int) (*db.Paginator, error) {
	...
	data := newsSyncMappingNewMakeDataArr()
...
// 获取 单条记录
func (s *NewsSyncMappingService) GetById(id int) (*models.NewsSyncMapping, error) {
